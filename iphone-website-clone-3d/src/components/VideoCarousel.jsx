...
import { hightlightsSlides, pauseImg, playImg, replayImg } from "../utils";
  ...
  return (
    <>
      ...
      <div className="relative flex items-center justify-center mt-10">
        <div className="flex items-center justify-center py-5 px-7 bg-gray-500 backdrop-blur rounded-full">
        ...
        <button className="ml-4 p-4 rounded-full bg-gray-500 backdrop-blur flex-center">
          <img
